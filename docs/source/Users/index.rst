...
All the configuration are rather simple with just drop down buttons without any need of programming proficiency. We will cover different aspects of the interface followed with an exemplary tutorials on how to use it. 
